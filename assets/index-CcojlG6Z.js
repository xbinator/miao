import{_ as t}from"./DemoSection-Bc-xJxmC.js";import{q as a,aA as c,aB as s,aC as _,aD as r,A as n}from"./index-DhbetlwR.js";const p=`豫章故郡，洪都新府。星分翼轸，地接衡庐。襟三江而带五湖，控蛮荆而引瓯越。物华天宝，龙光射牛斗之墟；人杰地灵，徐孺下陈蕃之榻。雄州雾列，俊采星驰。台隍枕夷夏之交，宾主尽东南之美。都督阎公之雅望，棨戟遥临；宇文新州之懿范，襜帷暂驻。十旬休假，胜友如云；千里逢迎，高朋满座。腾蛟起凤，孟学士之词宗；紫电青霜，王将军之武库。家君作宰，路出名区；童子何知，躬逢胜饯。
...
最后，确保回复的格式正确，分段清晰，使用正确的标点。可能用户需要复制粘贴，所以保持格式整齐很重要。现在，将知识库中的[8]内容整理成正确的分段，并检查是否有遗漏或错误。`,x=a({__name:"index",setup(m){return(u,i)=>{const e=c("MBubbleText"),o=t;return _(),s(o,null,{default:r(()=>[n(e,{content:"hello world"}),n(e,{content:p,"reason-content":l,typing:""})]),_:1})}}});export{x as default};
